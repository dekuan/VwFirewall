...
QColorMatrix::QColorMatrix()
{
	#ifndef __GDIPLUSSTARTUP_IN__
	#define __GDIPLUSSTARTUP_IN__
...
QColorMatrix::QColorMatrix( const QColorMatrix& m )
{
	#ifndef __GDIPLUSSTARTUP_IN__
	#define __GDIPLUSSTARTUP_IN__
...
QColorMatrix::~QColorMatrix()
{
	#ifndef __GDIPLUSSTARTUP_OUT__
	#define __GDIPLUSSTARTUP_OUT__
		//	Ð¶ÔØgdi+ 
