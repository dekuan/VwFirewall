...
public:
	...
	enum Color { clrBlack,  clrThinBlack, clrWhite, clrMaroon,  clrGreen,
		     clrOlive,  clrNavy,  clrPurple,  clrTeal,
		     clrSilver, clrGray,  clrRed,     clrLime,
		     clrYellow, clrBlue,  clrFuschia, clrAqua };
