...
BEGIN_MESSAGE_MAP(CButtonST2002, CButton)
    //{{AFX_MSG_MAP(CButtonST2002)
	ON_WM_SETCURSOR()
	ON_WM_KILLFOCUS()
	ON_WM_MOUSEMOVE()
...
void CButtonST2002::FreeResources(BOOL bCheckForNULL)
{
	if (bCheckForNULL)
	{
		// Destroy icons
...
void CButtonST2002::PreSubclassWindow() 
{
	UINT nBS;
...
UINT CButtonST2002::OnGetDlgCode() 
{
...
BOOL CButtonST2002::PreTranslateMessage(MSG* pMsg) 
{
	InitToolTip();
...
LRESULT CButtonST2002::DefWindowProc(UINT message, WPARAM wParam, LPARAM lParam) 
{
...
HBRUSH CButtonST2002::CtlColor(CDC* pDC, UINT nCtlColor) 
{
	return (HBRUSH)::GetStockObject(NULL_BRUSH); 
} // End of CtlColor

void CButtonST2002::OnSysColorChange() 
{
...
LRESULT CButtonST2002::OnSetStyle(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CButtonST2002::OnSetCheck(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CButtonST2002::OnGetCheck(WPARAM wParam, LPARAM lParam)
{
	ASSERT(m_bIsCheckBox);
	return GetCheck();
} // End of OnGetCheck
...
#ifdef	BTNST_USE_BCMENU
LRESULT CButtonST2002::OnMenuChar(UINT nChar, UINT nFlags, CMenu* pMenu) 
{
	LRESULT lResult;
...
#ifdef	BTNST_USE_BCMENU
void CButtonST2002::OnMeasureItem(int nIDCtl, LPMEASUREITEMSTRUCT lpMeasureItemStruct) 
{
	BOOL bSetFlag = FALSE;
...
void CButtonST2002::OnEnable(BOOL bEnable) 
{
...
void CButtonST2002::OnKillFocus(CWnd * pNewWnd)
{
	CButton::OnKillFocus(pNewWnd);
	CancelHover();
} // End of OnKillFocus

void CButtonST2002::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized) 
{
	CButton::OnActivate(nState, pWndOther, bMinimized);
	if (nState == WA_INACTIVE)	CancelHover();
} // End of OnActivate

void CButtonST2002::OnCancelMode() 
{
	CButton::OnCancelMode();
	CancelHover();
} // End of OnCancelMode

BOOL CButtonST2002::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
{
...
void CButtonST2002::CancelHover()
{
...
void CButtonST2002::OnMouseMove(UINT nFlags, CPoint point)
{
...
LRESULT CButtonST2002::OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
	CancelHover();
	return 0;
} // End of OnMouseLeave

BOOL CButtonST2002::OnClicked() 
{	
	SetFocus();
...
void CButtonST2002::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
...
void CButtonST2002::PaintBk(CDC* pDC)
{
...
HBITMAP CButtonST2002::CreateBitmapMask(HBITMAP hSourceBitmap, DWORD dwWidth, DWORD dwHeight, COLORREF crTransColor)
{
	HBITMAP		hMask		= NULL;
	HDC			hdcSrc		= NULL;
	HDC			hdcDest		= NULL;
...
//
void CButtonST2002::PrepareImageRect(BOOL bHasTitle, RECT* rpItem, CRect* rpTitle, BOOL bIsPressed, DWORD dwWidth, DWORD dwHeight, CRect* rpImage)
{
	CRect rBtn;
...
void CButtonST2002::DrawTheIcon(CDC* pDC, BOOL bHasTitle, RECT* rpItem, CRect* rpTitle, BOOL bIsPressed, BOOL bIsDisabled)
{
	BYTE		byIndex		= 0;
...
void CButtonST2002::DrawTheBitmap(CDC* pDC, BOOL bHasTitle, RECT* rItem, CRect *rCaption, BOOL bIsPressed, BOOL bIsDisabled)
{
	HDC			hdcBmpMem	= NULL;
...
//
HICON CButtonST2002::CreateGrayscaleIcon(HICON hIcon)
{
...
//
DWORD CButtonST2002::SetIcon(int nIconIn, int nIconOut)
{
	HICON		hIconIn			= NULL;
	HICON		hIconOut		= NULL;
...
//			Failed loading the specified resource.
//
DWORD CButtonST2002::SetIcon(HICON hIconIn, HICON hIconOut)
{
	BOOL		bRetValue;
	ICONINFO	ii;
...
//
DWORD CButtonST2002::SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut, COLORREF crTransColorOut)
{
...
//			Failed creating mask bitmap.
//
DWORD CButtonST2002::SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut, COLORREF crTransColorOut)
{
	int		nRetValue;
	BITMAP	csBitmapSize;
...
//				By default, CButtonST2002 buttons are flat.
//		[IN]	bRepaint
...
//			Function executed successfully.
//
DWORD CButtonST2002::SetFlat(BOOL bFlat, BOOL bRepaint)
{
	m_bIsFlat = bFlat;
...
//				By default, CButtonST2002 buttons have ST_ALIGN_HORIZ alignment.
//		[IN]	bRepaint
//				If TRUE the control will be repainted.
//
// Return value:
...
//
DWORD CButtonST2002::SetAlign(BYTE byAlign, BOOL bRepaint)
{
	switch (byAlign)
	{    
		case ST_ALIGN_HORIZ:
...
//			Function executed successfully.
//
DWORD CButtonST2002::SetCheck(int nCheck, BOOL bRepaint)
{
	if (m_bIsCheckBox)
	{
...
//			Function executed successfully.
//
DWORD CButtonST2002::SetDefaultColors(BOOL bRepaint)
{
...
//			Invalid color index.
//
DWORD CButtonST2002::SetColor(BYTE byColorIndex, COLORREF crColor, BOOL bRepaint)
{
...
//			Invalid color index.
//
DWORD CButtonST2002::GetColor(BYTE byColorIndex, COLORREF* crpColor)
{
	if (byColorIndex >= BTNST_MAX_COLORS)	return BTNST_INVALIDINDEX;
...
//
DWORD CButtonST2002::OffsetColor(BYTE byColorIndex, short shOffset, BOOL bRepaint)
{
	BYTE	byRed = 0;
	BYTE	byGreen = 0;
	BYTE	byBlue = 0;
...
//			Function executed successfully.
//
DWORD CButtonST2002::SetAlwaysTrack(BOOL bAlwaysTrack)
{
...
//			Failed loading the specified resource.
//
DWORD CButtonST2002::SetBtnCursor(int nCursorId, BOOL bRepaint)
{
	HINSTANCE	hInstResource = NULL;
...
//			Function executed successfully.
//
DWORD CButtonST2002::DrawBorder(BOOL bDrawBorder, BOOL bRepaint)
{
...
//			Function executed successfully.
//
DWORD CButtonST2002::DrawFlatFocus(BOOL bDrawFlatFocus, BOOL bRepaint)
{
...
void CButtonST2002::InitToolTip()
{
...
//
void CButtonST2002::SetTooltipText(int nText, BOOL bActivate)
{
	CString sText;
...
//				If TRUE the tooltip will be created active.
//
void CButtonST2002::SetTooltipText(LPCTSTR lpszText, BOOL bActivate)
{
...
//
void CButtonST2002::ActivateTooltip(BOOL bActivate)
{
...
//				If TRUE the control will be repainted.
//
void CButtonST2002::DrawTransparent(BOOL bRepaint)
{
...
//			Function executed successfully.
//
DWORD CButtonST2002::SetURL(LPCTSTR lpszURL)
{
...
//
#ifndef	BTNST_USE_BCMENU
DWORD CButtonST2002::SetMenu(UINT nMenu, HWND hParentWnd, BOOL bRepaint)
{
	HINSTANCE	hInstResource	= NULL;
...
//
#ifdef	BTNST_USE_BCMENU
DWORD CButtonST2002::SetMenu(UINT nMenu, HWND hParentWnd, BOOL bWinXPStyle, UINT nToolbarID, CSize sizeToolbarIcon, COLORREF crToolbarBk, BOOL bRepaint)
{
	BOOL	bRetValue = FALSE;
...
// This is a virtual function that can be rewritten in CButtonST2002-derived classes
...
//			Function executed successfully.
//
DWORD CButtonST2002::OnDrawBackground(CDC* pDC, LPCRECT pRect)
{
	COLORREF	crColor;
...
//			Function executed successfully.
//
DWORD CButtonST2002::OnDrawBorder(CDC* pDC, LPCRECT pRect)
{
	if (m_bIsPressed)
