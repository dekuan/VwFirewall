/*
    ...
    Thanks to:
      ...
      Yaffe, Gunnar Andr?Dalsnes, Vadim V Vorobev, Ashot Oganesyan K,
...
#define IS_WDK_BUILDENV	1


#ifndef __NTIFS_HEADER__
#define __NTIFS_HEADER__
